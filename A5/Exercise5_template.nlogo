...
to setup
  ...
  ;TODO: add here methods for mouse-tracking, etc.
  ;
  ;
...
to go
  ;TODO: let first growing point move
  ;
  ;
...
to hide-radius
  ;TODO: code for switching visualization off
  ;
  ;
...
to visualize-radius
  ;TODO: code for switching visualization on
  ;
  ;
